...
export function ComingSoonBadge({ className }: Props) {
  return (
    <div
      className={cn(
        "inline-flex items-center gap-2.5 rounded-full border border-accent/30 bg-gradient-to-r from-accent/15 via-accent/10 to-accent/15 px-4 py-2 backdrop-blur-sm",
        className,
      )}
    >
