    ...
    <section className="bg-paper-alt py-24 md:py-32">
      <Container className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
        ...
        <RevealOnScroll className="order-1 flex items-center justify-center gap-3 sm:gap-6 lg:order-2">
          <div className="flex min-w-0 basis-44 flex-col items-center gap-3 md:basis-52">
            <div className="relative h-56 w-full max-w-44 overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-100 shadow-sm md:h-64 md:w-52">
              <Image
                src="/images/featured-product/before.jpg"
                alt={t("beforeAlt")}
                fill
          ...
          <div className="flex min-w-0 basis-44 flex-col items-center gap-3 md:basis-52">
            <div className="relative h-56 w-full max-w-44 overflow-hidden rounded-2xl bg-white shadow-[0_24px_48px_-16px_rgba(225,29,72,0.25)] md:h-64 md:w-52">
              <Image
